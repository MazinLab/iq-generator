...
entity iq_gen_control_s_axi is
generic (
...
architecture behave of iq_gen_control_s_axi is
    type states is (wridle, wrdata, wrresp, wrreset, rdidle, rddata, rdreset);  -- read and write fsm states
    signal wstate  : states := wrreset;
    signal rstate  : states := rdreset;
    signal wnext, rnext: states;
    constant ADDR_MAX_DATA_0 : INTEGER := 16#10#;
    constant ADDR_MAX_CTRL   : INTEGER := 16#14#;
    constant ADDR_RUN_DATA_0 : INTEGER := 16#18#;
    constant ADDR_RUN_CTRL   : INTEGER := 16#1c#;
    ...
    -- internal registers
    signal int_max             : UNSIGNED(19 downto 0) := (others => '0');
            ...
            if (ACLK_EN = '1') then
                if (ar_hs = '1') then
                    ...
                    when ADDR_MAX_DATA_0 =>
                        rdata_data <= RESIZE(int_max(19 downto 0), 32);
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_MAX_DATA_0) then
                    int_max(19 downto 0) <= (UNSIGNED(WDATA(19 downto 0)) and wmask(19 downto 0)) or ((not wmask(19 downto 0)) and int_max(19 downto 0));
                end if;
            end if;
        end if;
    end process;
