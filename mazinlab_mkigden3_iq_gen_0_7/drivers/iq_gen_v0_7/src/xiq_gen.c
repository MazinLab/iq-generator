...
void XIq_gen_Set_run(XIq_gen *InstancePtr, u32 Data) {
    ...
    XIq_gen_WriteReg(InstancePtr->Control_BaseAddress, XIQ_GEN_CONTROL_ADDR_RUN_DATA, Data);
}
...
u32 XIq_gen_Get_run(XIq_gen *InstancePtr) {
    ...
    Data = XIq_gen_ReadReg(InstancePtr->Control_BaseAddress, XIQ_GEN_CONTROL_ADDR_RUN_DATA);
    return Data;
}
